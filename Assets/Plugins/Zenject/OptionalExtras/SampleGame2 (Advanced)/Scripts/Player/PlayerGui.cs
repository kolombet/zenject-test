...
namespace Zenject.SpaceFighter
{
    public class PlayerGui : MonoBehaviour
    {
        ...
        InjectedPlayer _injectedPlayer;
        ...
        [Inject]
        public void Construct(InjectedPlayer injectedPlayer, SignalBus signalBus)
        {
        ...
        public void OnGUI()
        {
            ...
            GUI.Label(healthLabelBounds, "Health: {0:0}".Fmt(_injectedPlayer.Health));
            ...
            var boundsForeground = new Rect(boundsBackground.xMin, boundsBackground.yMin, (_injectedPlayer.Health / 100.0f) * _textureWidth, _textureHeight);
            GUI.DrawTexture(boundsForeground, _textureForeground);

            exp.text = _injectedPlayer.Exp.ToString();
        }
    }
}
